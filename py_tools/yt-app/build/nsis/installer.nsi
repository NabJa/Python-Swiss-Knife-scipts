!define PRODUCT_NAME "YT-converter"
!define PRODUCT_VERSION "1.0"
!define PY_VERSION "3.6.7"
!define PY_MAJOR_VERSION "3.6"
!define BITNESS "32"
!define ARCH_TAG ""
!define INSTALLER_NAME "YT-converter_1.0.exe"
!define PRODUCT_ICON "logo.png"
...
!define MULTIUSER_INSTALLMODE_INSTDIR "YT-converter"
...
Section "!${PRODUCT_NAME}" sec_app
  ...
  SetOutPath "%HOMEDRIVE%\%HOMEPATH%"
    CreateShortCut "$SMPROGRAMS\YT-converter.lnk" "$INSTDIR\Python\pythonw.exe" \
      '"$INSTDIR\YT-converter.launch.pyw"' "$INSTDIR\logo.png"
  SetOutPath "$INSTDIR"
...
Section "Uninstall"
  ...
  ; Uninstall files
    ...
    Delete "$INSTDIR\YT-converter.launch.pyw"
  ; Uninstall directories
    RMDir /r "$INSTDIR\Python"

  ; Uninstall shortcuts
      Delete "$SMPROGRAMS\YT-converter.lnk"
  RMDir $INSTDIR
